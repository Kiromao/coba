...
public class FileUtils {
    ...
    public static ArrayList<String> getTrainingFnms(ArrayList ALfnms) // return all the names of the training image files + their paths
    {
...
//            }
//        });
        String[] fnms = new String[ALfnms.size()];
        
        for (int i = 0; i < ALfnms.size(); i++) {
            fnms[i] = ALfnms.get(i).toString();
        }
