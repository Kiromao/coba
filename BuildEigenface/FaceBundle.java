...
public class FaceBundle implements Serializable {
    ...
    private ArrayList<String> id_mahasiswa;
    private double[] avgImage;   // average training image
    private double[][] eigenFaces;     // the eigenvectors for the face images
    private double[] eigenValues;
    private int imageWidth, imageHeight;

    public FaceBundle(ArrayList<String> nms,ArrayList<String> id_mhs, double[][] ims, double[] avgImg,
    ...
    public ArrayList<String> getId_mahasiswa() {
        return id_mahasiswa;
    }
