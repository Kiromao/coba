...
public class Equalization {
     ...
     * @throws IOException
     */
    public BufferedImage Equalization(BufferedImage fileName) throws IOException {
...
// 4 , 8 , 17
    ...
    public void writeImage(String output, String fileName, BufferedImage img) throws IOException {
        File file = new File(output + "\\" + fileName + "HE.png");
        ImageIO.write(img, "png", file);
    }

    public String fileName(File file) throws IOException {
        String fileName = file.getName().substring(8, file.getName().length() - 4);
        return fileName;
    }
